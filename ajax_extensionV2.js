(function(ext) {
    ...
    var descriptor = {
        blocks: [
            ...
            ['w', 'set %m.lights to %m.power power', 'set_power', "All Lights", 'High'],
            ['w', 'set fade speed to %m.speeds', 'set_fade_speed', 'Slow'],
            ['w', '%m.lights fade in %m.colors', 'fade_in', "All Lights", "Red"],
            ['w', '%m.lights fade out %m.colors', 'fade_in', "All Lights", "Red"],
            // Motor cmds
            ['w', 'turn on Motor', 'send_motor_on'],
            ['w', 'turn off Motor', 'send_motor_off'],
            ['w', 'toggle motor', 'send_motor_toggle'],
            ['w', 'reverse motor', 'send_motor_rev'],
