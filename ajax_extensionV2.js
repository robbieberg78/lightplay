(function(ext) {
    ...
    var descriptor = {
        blocks: [
            ...
            ['w', 'set the color of %m.lights to %m.colors', 'set_color', “all lights", “red"],
            ...
            ['w', 'set the fade speed to %m.speeds', 'set_fade_speed', ‘slow'],
            ['w', 'set the brightness of %m.lights to %m.power', 'set_power', “all lights", ‘high'],
            // Motor cmds
