...
// output pin numbers:
int white = 11; // this in the pinnumber for the white LED
int blue = 10; // this in the pinnumber for the blue LED
int green = 9; // this in the pinnumber for the green LED
int red = 6; // this in the pinnumber for the red LED
...
int dt = 50; // time delay used in change color loop
