...
byte ybits = 0; //3 LSBs used for which color or subcommand
...
// this table contains the RGBW values for colors 0-6, in order. + for iPad version color 7 is black
...
boolean ipad = true; // ipad version? 
...
void resetstate()
  {
    motorspeed = 10;
    motor_is_on = false; // 
    thisway = true;  // direction state
    motora_alt = false; // remember if digital state has been temporarily altered for speed control
    motorb_alt = false; // remember if digital state has been temporarily altered for speed control
    light1color = 7; // set current color of light 1 to black
    light2color = 7; // set current color of light 2 to black
    light3color = 7; // set current color of light 3 to black
    light1power = 1; // power divisor for light 1
    light2power = 1; // power divisor for light 2
    light3power = 1; // power divisor for light 3
    ...
    ipad = true; // issue reset from ipad only as a way to detect who is host
